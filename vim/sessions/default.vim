...
setlocal statusline=%{lightline#link()}%#LightlineLeft_active_0#%(\ %{lightline#mode()}\ %)%{(&paste)?\"\":\"\"}%(\ %{&paste?\"PASTE\":\"\"}\ %)%#LightlineLeft_active_0_1#%#LightlineLeft_active_1#%(\ %R\ %)%{(&readonly)&&(1||(&modified||!&modifiable)||1||exists(\"*custom#lightline#devicons\")&&custom#lightline#devicons()!=#\"\")?\"\":\"\"}%(\ %t\ %)%{(&modified||!&modifiable)||1||exists(\"*custom#lightline#devicons\")&&custom#lightline#devicons()!=#\"\"?\"\":\"\"}%(\ %M\ %)%{(&modified||!&modifiable)&&(1||exists(\"*custom#lightline#devicons\")&&custom#lightline#devicons()!=#\"\")?\"\":\"\"}%(\ %{&fenc!=#\"\"?&fenc:&enc}[%{&ff}]\ %)%{exists(\"*custom#lightline#devicons\")&&custom#lightline#devicons()!=#\"\"?\"\":\"\"}%(\ %{exists(\"*custom#lightline#devicons\")?custom#lightline#devicons():\"\"}\ %)%#LightlineLeft_active_1_2#%#LightlineMiddle_active#%=%#LightlineRight_active_1_2#%#LightlineRight_active_1#%#LightlineRight_active_0_1#%#LightlineRight_active_0#%(\ %2p%%\ %3l:%-2v\ %)
